...
/**
 * UserGroup Assigned IP Addresses
 *
...
/**
 * UserGroup_AssignedIPs
 *
 * Use the following API calls to view, assign and delete virtual server recipes in your cloud.
 *
 * The OnApp_UserGroup_AssignedIPs class uses the following basic methods:
 * {@link edit}.
 *
 * For full fields reference and curl request details visit: ( http://help.onapp.com/manual.php?m=2 )
 */

class OnApp_UserGroup_AssignedIPs extends OnApp {
    /**
    ...
    function getResource( $action = ONAPP_GETRESOURCE_DEFAULT ) {
        switch ( $action ) {
            case ONAPP_GETRESOURCE_DEFAULT:
                 ...
                 * ROUTE :
                 *
                 * @name Get List of IP Addresses Assigned to Users Within User Group
                 * @method GET
                 * @alias  /user_groups/:user_group_id/assigned_ips(.:format)
                 * @format {:controller=>"UserGroup_AssignedIPs", :action=>"getList"}
                 */
