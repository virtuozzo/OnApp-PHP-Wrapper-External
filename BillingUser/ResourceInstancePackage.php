...
/**
 * The OnApp_BillingUser_ResourceInstancePackage class uses the following basic methods:
 * {@link load}, {@link save}, {@link delete}, and {@link getList}.
 *
 * For full fields reference and curl request details visit: ( http://help.onapp.com/manual.php?m=2 )
 */
class OnApp_BillingUser_ResourceInstancePackage extends OnApp_BillingUser_BaseResource {
    /**
...
//    var $_resource = 'resource_edge_groups';
     ...
     * @var string
     */
    var $_specified_resource_name = 'instance_package';
        ...
        switch ( $version ) {
            ...
            case 4.2:
                $this->fields['resource_class'] = array(
                    ...
                    ONAPP_FIELD_DEFAULT_VALUE => 'Billing::Resource::InstancePackage',
                );
                ...
                $this->fields['target_type'] = array(
                    ...
                    ONAPP_FIELD_TYPE          => 'string',
                    ONAPP_FIELD_REQUIRED      => true,
                    ONAPP_FIELD_DEFAULT_VALUE => 'InstancePackage',
                );
