...
/**
 * The OnApp_BillingUser_ResourceDRaaS class uses the following basic methods:
 * {@link load}, {@link save}, {@link delete}, and {@link getList}.
 *
 * For full fields reference and curl request details visit: ( http://help.onapp.com/manual.php?m=2 )
 */
class OnApp_BillingUser_ResourceDRaaS extends OnApp_BillingUser_BaseResource {
    /**
     * specified resource name for getList
     *
     * @var string
     */
    var $_specified_resource_name = 'draas';
