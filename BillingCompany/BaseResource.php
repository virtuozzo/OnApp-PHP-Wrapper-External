...
/**
 * Company Billing Plan Base Resources
 *
...
/**
 * The OnApp_BillingCompany_BaseResource uses the following basic methods:
 * {@link load}, {@link save}, {@link delete}, and {@link getList}.
 *
 * For full fields reference and curl request details visit: ( http://help.onapp.com/manual.php?m=2 )
 */
class OnApp_BillingCompany_BaseResource extends OnApp {
    /**
            ...
            case 4.2:
                $this->fields = array(
                    ...
                    'prices'          => array(
                        ...
                        ONAPP_FIELD_READ_ONLY => true,
                        ONAPP_FIELD_TYPE      => 'array',
                        ONAPP_FIELD_CLASS     => 'BillingCompany_BaseResource_Price',
                    ),
                    'limit'           => array(
    ...
    function getResource( $action = ONAPP_GETRESOURCE_DEFAULT ) {
        ...
        switch( $action ) {
            case ONAPP_GETRESOURCE_DEFAULT:
                 ...
                 * ROUTE :
                 *
                 * @name company_billing_plan_base_resources
                 * @method GET
                 * @alias   /billing/company/plans/:billing_plan_id/resources(.:format)
                 ...
                 * @name company_billing_plan_base_resources
                 * @method GET
                 * @alias    /billing/company/plans/:billing_plan_id/resources/:id(.:format)
                ...
                $resource = 'billing/company' . $resourceAdd . '/' . $this->_resource;
                break;
