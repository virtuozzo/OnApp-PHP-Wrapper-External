...
/**
 * Company Billing Plan Base Resources VCloud Network Zone
 *
...
/**
 * The OnApp_BillingCompany_ResourceVCloudNetworkZone class uses the following basic methods:
 * {@link load}, {@link save}, {@link delete}, and {@link getList}.
 *
 * For full fields reference and curl request details visit: ( http://help.onapp.com/manual.php?m=2 )
 */
class OnApp_BillingCompany_ResourceVCloudNetworkZone extends OnApp_BillingCompany_BaseResource {
    /**
        ...
        switch( $version ) {
            ...
            case 4.2:
                $this->fields[ 'resource_class' ] = array(
                    ...
                    ONAPP_FIELD_DEFAULT_VALUE => 'Billing::Company::Resource::VCloud::NetworkZone',
                );
