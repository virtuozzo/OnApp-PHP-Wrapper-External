 ...
 * @author	 Andrew Yatskovets <ayatsk@onapp.com>
 */
class Template_TestCase extends OnApp_TestCase {
	private $_onapp_config = array();

	public static function main() {
		$suite = new PHPUnit_Framework_TestSuite( 'Template_TestCase' );
 ...
 */
if( PHPUnit_MAIN_METHOD == 'Template_TestCase::main' ) {
