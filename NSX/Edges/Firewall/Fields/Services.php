...
/**
 * NSX Edges Firewall Fields Services
 *
...
/**
 * NSX_Edges_Firewall_Fields_Services
 *
 * Use the following API calls to view, assign and delete virtual server recipes in your cloudю
 *
 * For full fields reference and curl request details visit: ( http://help.onapp.com/manual.php?m=2 )
 */
class OnApp_NSX_Edges_Firewall_Fields_Services extends OnApp {
    /**
     * root tag used in the API request
     *
     * @var string
     */
    var $_tagRoot = 'services';
            ...
            case 6.2:
                $this->fields = array(
                    ...
                    'destination_port'          => array(
                        ONAPP_FIELD_MAP     => '_destination_port',
                        ONAPP_FIELD_TYPE    => 'string',
                    ),
                );
                break;
