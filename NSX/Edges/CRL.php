 ...
 *
 * The OnApp_NSX_Edges_CRL class uses the following basic method:
 * {@link getList}
 *
 * For full fields reference and curl request details visit: ( http://help.onapp.com/manual.php?m=2 )
 */
class OnApp_NSX_Edges_CRL extends OnApp {
    /**
     * root tag used in the API request
     *
     * @var string
     */
    var $_tagRoot = 'nsx_crl';
    /**
    ...
    function getResource( $action = ONAPP_GETRESOURCE_DEFAULT ) {
        switch ( $action ) {
            case ONAPP_GETRESOURCE_DEFAULT:
                 ...
                 * ROUTE :
                 *
                 * @name Get List of CRL Certificates
                 * @method GET
                 * @alias  /nsx/edges/:edge_id/crls(.:format)
                 * @format {:controller=>"NSX_Edges_CRL", :action=>"index"}
                 */
